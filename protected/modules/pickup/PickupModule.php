<?php
/**
 * PickupModule основной класс модуля pickup
 *
 * @author yupe team <team@yupe.ru>
 * @link https://yupe.ru
 * @copyright 2009-2020 amyLabs && Yupe! team
 * @package yupe.modules.pickup
 * @since 0.1
 */

class PickupModule extends yupe\components\WebModule
{
    const VERSION = '0.9.8';
    ...
    {
        return Yii::t('PickupModule.pickup', 'Магазин');
    }
    ...
    {
        return [
            ['label' => Yii::t('PickupModule.pickup', 'Самовывоз')],
            [
                'icon' => 'fa fa-fw fa-list-alt',
                'label' => Yii::t('PickupModule.pickup', 'Адреса'),
                'url' => ['/pickup/pickupBackend/index']
            ],
            [
                'icon' => 'fa fa-fw fa-list-alt',
                'label' => Yii::t('PickupModule.pickup', 'Добавить адрес'),
                'url' => ['/pickup/pickupBackend/create']
            ],
        ];
    }
    ...
    {
        return Yii::t('PickupModule.pickup', self::VERSION);
    }
    ...
    {
        return Yii::t('PickupModule.pickup', 'https://yupe.ru');
    }
    ...
    {
        return Yii::t('PickupModule.pickup', 'Самовывоз');
    }
    ...
    {
        return Yii::t('PickupModule.pickup', 'Модуль "Самовывоз" используется для расширения модуля "Доставка"');
    }
    ...
    {
        return Yii::t('PickupModule.pickup', 'yupe team');
    }
    ...
    {
        return Yii::t('PickupModule.pickup', 'team@yupe.ru');
    }
    ...
    {
        return '/pickup/pickupBackend/index';
    }
    ...
    public function getAuthItems()
    {
        return [
            [
                'name' => 'Pickup.PickupManager',
                'description' => Yii::t('PickupModule.pickup', 'Manage pickup'),
                'type' => AuthItem::TYPE_TASK,
                'items' => [
                    [
                        'type' => AuthItem::TYPE_OPERATION,
                        'name' => 'Pickup.PickupBackend.Index',
                        'description' => Yii::t('PickupModule.pickup', 'Index')
                    ],
                ]
            ]
        ];
