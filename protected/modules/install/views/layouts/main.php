...
<head>
    ...
    ?>
    <link rel="shortcut icon" href="<?= $yupeAssets . '/image/favicon.ico'; ?>">
</head>
...
<body>
    ...
    <footer>
        ...
        <a href="http://amylabs.ru/?from=install" target="_blank">
            <?= Yii::t('YupeModule.yupe', 'Development and support'); ?></a> - <a href="http://amylabs.ru/?from=install" target="_blank">amylabs</a>
        <br />
        <?= Yii::powered(); ?>
    </footer>
    <!-- footer -->
