...
class StoreModule extends WebModule
{
     ...
     * @var int
     */
    public $smallImgWidth = 70;
    /**
     * @var int
     */
    public $smallImgHeight = 93;
    /**
     * @var int
     */
    public $imgWidth = 405;
    ...
    public function getSortList()
    {
        return [
            ...
            'visits' => Yii::t('StoreModule.store', 'Популярные'),
        ];
    }
    ...
    public function getParamsLabels()
    {
        return [
            ...
            'smallImgWidth' => Yii::t('StoreModule.store', 'Ширина для Small изображений в карточке товара'),
            'smallImgHeight' => Yii::t('StoreModule.store', 'Высота для Small изображений в карточке товара'),
            'imgWidth' => Yii::t('StoreModule.store', 'Ширина главного изображения в карточке товара'),
            'imgHeight' => Yii::t('StoreModule.store', 'Высота главного изображения в карточке товара'),
    ...
    public function getEditableParamsGroups()
    {
        return [
            '00.store' => [
                'label' => Yii::t('StoreModule.store', 'Настройки'),
                'items' => [
    ...
    {
        return CHtml::listData(StoreCategory::model()->findAll(), 'id', 'name');
    }

    public function getBadge($model)
    {
        $ids = [$this->newId, $this->stockId, $this->saleId];
