...
/**
 * ProductsPhotosReviewsMarketplaceWidget виджет отрисовки фотографий фото отзывов с маркетплейсов
 *
 * @category YupeWidget
...
Yii::import('application.modules.store.models.ProductPhotosReviewsMarketplace');

class ProductsPhotosReviewsMarketplaceWidget extends yupe\widgets\YWidget
{
    // сколько изображений выводить на одной странице
    public $limit = 10;

    public $view = 'products-photos-reviews-marketplace';

    public $js_class = 'js-products-photos-reviews-marketplace';
    ...
    public function run()
    {
        ...
        $dataProvider = new CActiveDataProvider(
            'ProductPhotosReviewsMarketplace',
            [
                'criteria' => $criteria
            ]
        );
