...
class AttributeValue extends yupe\models\YModel
{
    ...
    public function relations()
    {
        return [
            ...
            'optVal' => [self::HAS_ONE, 'AttributeOption', ['id'=>'option_value']],
            'optVals' => [self::HAS_MANY, 'AttributeOption', ['id'=>'option_value']],
        ];
    }
    ...
    public function store($attributeId, $value, Product $product)
    {
        ...
        if (!isset($this->attributes[$attributeId])) {
            $attribute = AttributeStore::model()->findByPk($attributeId);
    ...
    public function column($type)
    {
        ...
        $map = [
            AttributeStore::TYPE_DROPDOWN => 'option_value',
            AttributeStore::TYPE_CHECKBOX => 'number_value',
            AttributeStore::TYPE_NUMBER => 'number_value',
            AttributeStore::TYPE_TEXT => 'text_value',
            AttributeStore::TYPE_SHORT_TEXT => 'string_value',
            AttributeStore::TYPE_CHECKBOX_LIST => 'option_value',
            AttributeStore::TYPE_COLOR_LIST => 'option_value'
        ];
    ...
    {
        if (!$this->attribute->isType(AttributeStore::TYPE_FILE)) {
            return null;
        }
