    ...
    <div class="col-sm-3">
        ...
        $this->widget(
            ...
            [
                ...
                'sortableAction' => '/store/attributeStoreBackend/sortable',
                ...
                'columns' => [
                    [
                        ...
                        'editable' => [
                            'type' => 'text',
                            'url' => ['/store/attributeStoreBackend/inlineEditGroup'],
    ...
    <div class="col-sm-9">
        <?php $this->widget(
            ...
            [
                ...
                'sortableAction' => '/store/attributeStoreBackend/sortattr',
                'type' => 'condensed',
                ...
                'columns' => [
                    [
                        ...
                        'value' => function ($data) {
                            return CHtml::link($data->title,
                                array("/store/attributeStoreBackend/update", "id" => $data->id));
                        },
                    ],
                    [
                        'name' => 'name',
                        'type' => 'raw',
                        'value' => function ($data) {
                            return CHtml::link($data->name, array("/store/attributeStoreBackend/update", "id" => $data->id));
                        },
                    ],
                    [
                        'name' => 'type',
                    ...
                    [
                        ...
                        'name' => 'required',
                        'url' => $this->createUrl('/store/attributeStoreBackend/inlineattr'),
    ...
    $(document).ready(function () {
        ...
        $container.on('click', '#add-attribute-group', function (e) {
            ...
            if (name) {
                ...
                $.ajax({
                    url: '<?= Yii::app()->createUrl("/store/attributeStoreBackend/groupCreate")?>',
                    type: 'post',
                    data: data,
                    dataType: 'json',
