...
<div class="tab-content">
    <div class="tab-pane active" id="common">
        <div class='row'>
            <div class="col-sm-12">
                <?= $form->checkBoxGroup($model, 'show_in_catalog'); ?>
            </div>
            <div class="col-sm-3">
        ...
        <div class='row'>
            ...
            <div class="col-sm-4">
                <?= CHtml::image(
                    !$model->isNewRecord && $model->image_two ? $model->getImageTwoUrl(200, 200) : '#',
                    $model->name,
                    [
                        'class' => 'preview-image',
                        'style' => !$model->isNewRecord && $model->image_two ? '' : 'display:none',
                    ]
                ); ?>

                <?php if (!$model->isNewRecord && $model->image_two): ?>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="delete-image-two"> <?= Yii::t('YupeModule.yupe', 'Delete the file') ?>
                        </label>
                    </div>
                <?php endif; ?>
                <?= $form->fileFieldGroup($model, 'image_two'); ?>
            </div>
        </div>
        <div class='row'>
