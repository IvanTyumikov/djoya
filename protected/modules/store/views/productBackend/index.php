        ...
        'columns' => [
           ...
           /* [
            ...
            [
                'name'  => 'category_id',
                'value' => function($data){
                    $categoryList = '<span class="label label-primary" style="display: inline-block;">'. (isset($data->category) ? $data->category->name : '---') . '</span>';

                    foreach ($data->categories as $category) {
                        $categoryList .= '</span><span class="label label-default" style="display: inline-block;">' . $category->name .'</span>';
                    }
            ...
            [
                ...
                'name' => 'is_delivery',
                'url' => $this->createUrl('/store/productBackend/inline'),
                'source' => $model->getIsDeliveryList(),
                'options' => [
                    Product::IS_DELIVERY_NO => ['class' => 'label-warning'],
                    Product::IS_DELIVERY_YES => ['class' => 'label-success'],
                ],
            ],
            [
