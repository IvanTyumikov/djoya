                ...
                <fieldset>
                    ...
                    <?php foreach ($items as $attribute): ?>
                        ...
                        <div class="row form-group">
                            ...
                            <div
                                class="col-sm-<?= $attribute->isType(AttributeStore::TYPE_TEXT) ? 9 : 2; ?> <?= $hasError ? 'has-error' : null; ?>">
                                <?php $htmlOptions = $attribute->isType(AttributeStore::TYPE_CHECKBOX) || $attribute->isType(AttributeStore::TYPE_CHECKBOX_LIST) ? [] : ['class' => 'form-control']; ?>
                                <?php if ($attribute->isType(AttributeStore::TYPE_FILE)): ?>
