...
class ProductRepository extends CApplicationComponent
{
    ...
    public function getByFilter(array $mainSearchAttributes, array $typeSearchAttributes)
    {
        ...
        foreach ($this->attributeFilter->getMainSearchParams() as $param => $field) {
            ...
            } elseif ('news_product' === $param || 'hits_product' === $param) { 
                $criteria2->addInCondition("t.".$field, $mainSearchAttributes[$param], "OR");
            } elseif ('discounts_product' === $param) {
        ...
        $criteria->addNotInCondition('t.id', [
            0 => 92
        ]);
    ...
    public function getBySlug(
        ...
        $model = Product::model()->find('t.slug = :slug', [':slug' => $slug]);
