...
class YupeModule extends WebModule
{
    ...
    public function getParamsLabels()
    {
        return [
            ...
            'idYandexMetrika' => Yii::t('YupeModule.yupe', 'Id Яндекс метрики'),
            'phone1' => Yii::t('YupeModule.yupe', 'Телефон 1'),
            'phone2' => Yii::t('YupeModule.yupe', 'Телефон 2'),
            'time' => Yii::t('YupeModule.yupe', 'Часы работы'),
            'dayWork' => Yii::t('YupeModule.yupe', 'Дни работы'),
            'adress1' => Yii::t('YupeModule.yupe', 'Адрес производства 1'),
            'adress2' => Yii::t('YupeModule.yupe', 'Адрес производства 2'),
            'adress3' => Yii::t('YupeModule.yupe', 'Адрес производства 3'),
            'email' => Yii::t('YupeModule.yupe', 'Email'),
            'map' => Yii::t('YupeModule.yupe', 'Ссылка на карту'),
            'whatsapp' => Yii::t('YupeModule.yupe', 'Ссылка на whatsapp'),
            'telegram' => Yii::t('YupeModule.yupe', 'Ссылка на telegram'),
            'classmates' => Yii::t('YupeModule.yupe', 'Ссылка на Одноклассники'),
            'viber' => Yii::t('YupeModule.yupe', 'Ссылка на viber'),
        ];
    }
    ...
    public function getEditableParamsGroups()
    {
        return [
            ...
            'contacts' => [
                'label' => Yii::t('YupeModule.yupe', 'Contacts site'),
                'items' => [
                    'phone1',
                    'phone2',
                    'time',
