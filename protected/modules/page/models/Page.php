...
class Page extends yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['status, is_protected, order, noindex', 'numerical', 'integerOnly' => true, 'on' => ['update', 'insert']],
            ['parent_id, category_id', 'numerical', 'integerOnly' => true, 'allowEmpty' => true],
            ['image, data, icon', 'safe'],
    ...
    public function getViewsLists()
    {
        $data = [];

        foreach (new GlobIterator(Yii::app()->getTheme()->basePath.DIRECTORY_SEPARATOR.'views'.DIRECTORY_SEPARATOR.'page'.DIRECTORY_SEPARATOR.'page'.DIRECTORY_SEPARATOR.'*.php') as $item) {
