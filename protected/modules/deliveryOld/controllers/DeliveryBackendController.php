...
class DeliveryBackendController extends yupe\components\controllers\BackController
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['Delivery'])) {
            ...
            $model->setDeliverySystemSettings(Yii::app()->getRequest()->getPost('DeliverySettings', []));
    ...
    public function actionDeliverySystemSettings()
    {
        $delivery = Delivery::model()->findByPk(Yii::app()->request->getParam('delivery_id'));
        $this->renderPartial(
            '_delivery_system_settings',
            [
                'deliverySystem' => Yii::app()->request->getParam('delivery_system'),
                'deliverySettings' => $delivery ? $delivery->getDeliverySystemSettings() : [],
            ]
        );
    }
}
