 ...
 */
class Quest extends \yupe\models\YModel
{
	...
	public function rules()
	{
		return array(
			...
			array('id, name, body, status, position, category_id', 'safe', 'on' => 'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'category' => [self::BELONGS_TO, 'QuestCategory', ['category_id' => 'id']],
		);
	}
	...
	{
		return CHtml::listData(QuestCategory::model()->published()->findAll(), 'id', 'name');
	}
}
