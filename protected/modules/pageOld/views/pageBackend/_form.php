    ...
    <div class="tab-pane active" id="common">
        ...
        <div class="row">
            <?php //Использование Mirror для лучшей визуализации ?>
             <?=  $form->labelEx($model, 'text_mirror'); ?>
                <?php $this->widget(
                    'yupe\widgets\editors\Textarea',
                    [
                        'model'     => $model,
                        'attribute' => 'text_mirror',
                        'height' => 200
                    ]
                ); ?>
            <?=  $form->error($model, 'text_mirror'); ?>
        </div><br><br>
                ...
                <?= $form->textFieldGroup(
                    ...
                    [
                        'widgetOptions' => [
                            'htmlOptions' => [
                                'class' => 'popover-help',
                                'data-original-title' => $model->getAttributeLabel('meta_robots'),
                                'data-content' => $model->getAttributeDescription('meta_robots'),
                            ],
                        ],
                    ]
                ); ?>
