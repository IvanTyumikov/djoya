...
class ProfileForm extends CFormModel
{
    ...
    public function rules()
    {
        ...
        return [
            ['nick_name, first_name, last_name, middle_name, about, zipcode, city', 'filter', 'filter' => 'trim'],
            [
                'nick_name, first_name, last_name, middle_name, about',
                'filter',
                'filter' => [$obj = new YPurifier(), 'purify']
            ],
            ['nick_name,  first_name, last_name, middle_name, zipcode, city', 'required'],
            ...
            // ['phone', 'match', 'pattern' => '/\+7\(\d{3}\) \d{3}-\d{4}/', 'message' => 'Не правильный формат телефона' ],
            ['location', 'safe']
        ];
    }
