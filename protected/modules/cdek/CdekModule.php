<?php
/**
 * CdekModule основной класс модуля cdek
 *
 * @author yupe team <team@yupe.ru>
 * @link https://yupe.ru
 * @copyright 2009-2020 amyLabs && Yupe! team
 * @package yupe.modules.cdek
 * @since 0.1
 */

class CdekModule extends yupe\components\WebModule
{
    const VERSION = '0.9.8';
    ...
    {
        return Yii::t('CdekModule.cdek', 'Магазин');
    }
    ...
    {
        return Yii::t('CdekModule.cdek', self::VERSION);
    }
    ...
    {
        return Yii::t('CdekModule.cdek', 'https://yupe.ru');
    }
    ...
    {
        return Yii::t('CdekModule.cdek', 'СДЭК');
    }
    ...
    {
        return Yii::t('CdekModule.cdek', 'Описание модуля "cdek"');
    }
    ...
    {
        return Yii::t('CdekModule.cdek', 'yupe team');
    }
    ...
    {
        return Yii::t('CdekModule.cdek', 'team@yupe.ru');
    }
    ...
    public function getAuthItems()
    {
        return [
            [
                'name' => 'Cdek.CdekManager',
                'description' => Yii::t('CdekModule.cdek', 'Manage cdek'),
                'type' => AuthItem::TYPE_TASK,
                'items' => [
                    [
                        'type' => AuthItem::TYPE_OPERATION,
                        'name' => 'Cdek.CdekBackend.Index',
                        'description' => Yii::t('CdekModule.cdek', 'Index')
                    ],
                ]
            ]
        ];
