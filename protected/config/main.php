...
return [
    ...
    'components' => [
        'cityRepository' => [
            'class' => 'application.modules.yupe.components.repository.CityRepository'
        ],
        // Using main-back or main-front
        'clientScript' => [
            'scriptMap' => [
        ...
        'urlManager' => [
            ...
            'class' => 'yupe\components\urlManager\LangCityUrlManager',
            'langParam' => 'language',
            'urlFormat' => 'path',
            'urlSuffix' => '',
            /**
