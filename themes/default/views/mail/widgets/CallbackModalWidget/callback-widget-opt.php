<div id="callbackModalOpt" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal__header">
                ...
                <div class="modal__title">Получить <br> оптовый прайс</div>
                <div class="modal__desc">Оставьте заявку<br> и мы Вам перезвоним!</div>
            </div>

            <?php $form = $this->beginWidget('bootstrap.widgets.TbActiveForm', [
                'id'=>'callback-modal-form-opt',
                'type' => 'vertical',
                ...
                <div class="modal__body modal-form__body">
                    <?= $form->hiddenField($model, 'title', ['value' => 'Получить оптовый прайс']); ?>
                    ...
                    <div class="modal-form__bot">
                        <div class="modal-form__but">
                            <button class="button" id="callback-modal-button-opt" data-send="ajax">Отправить</button>
                        </div>
                    </div>
