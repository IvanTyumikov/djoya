<div id="callbackModalOrder" class="modal fade" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <?php $form = $this->beginWidget('bootstrap.widgets.TbActiveForm', [
                    ...
                    <div class="modal__body modal-form__body">
                        <?= $form->hiddenField($model, 'title', ['value' => 'Заказать звонок']); ?>
                        ...
                        <div class="modal-form__bot">
                            <div class="modal-form__but">
                                <button class="button" id="callback-modal-button-order" data-send="ajax">Отправить</button>
                            </div>
                        </div>
