<div id="callbackModalAffiliate" class="modal fade" role="dialog" aria-hidden="true">
        ...
        <noindex>
            <div class="modal-content">
                <div class="modal__header">
                    ...
                    <div class="modal__title">Оставить <br> заявку!</div>
<!--                    <div class="modal__desc">Оставьте заявку<br> и мы Вам перезвоним!</div>-->
                </div>

                <?php $form = $this->beginWidget('bootstrap.widgets.TbActiveForm', [
                    'id'=>'callback-modal-form-affiliate',
                    'type' => 'vertical',
                    ...
                    <?php if (Yii::app()->user->hasFlash('callback-success')) : ?>
                        <script>
                            ...
                            yaCounter<?= Yii::app()->params['metrika'] ?>.reachGoal('affiliateFormCallback');
                    
                            $('#callbackModalAffiliate').modal('hide');
                    ...
                    <div class="modal__body modal-form__body">
                        <?= $form->hiddenField($model, 'title', ['value' => 'Заявка ОПТ']); ?>
                        ...
                        <div class="modal-form__bot">
                            <div class="modal-form__but">
                                <button class="btn btn-green" id="callback-modal-button-affiliate" data-send="ajax">Отправить</button>
                            </div>
                        </div>
